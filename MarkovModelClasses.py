...
class Patient:
    ...
    def get_numberofstroke(self):

        return self._stateMonitor.get_numberofstroke()
...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state == P.HealthStats.Stroke:
           self._numberofstroke.append(1)
        else:
            self._numberofstroke.append(0)
    ...
    def get_numberofstroke(self):
        return sum(self._numberofstroke)
...
class CohortOutputs:
    ...
    def get_mean_strokes(self):
        print(sum(self._strokes)/len(self._strokes))
